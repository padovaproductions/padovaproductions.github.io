...
const b1_BoxEdges = new THREE.EdgesGeometry( b1_Geometry );
const b1_BoxLines = new THREE.LineSegments( b1_BoxEdges, new THREE.LineBasicMaterial( { color: blockColor } ) );
b1_BoxLines.position.set(0, -0.2499, 1)
scene.add( b1_BoxLines );
...
const b2_BoxEdges = new THREE.EdgesGeometry( b2_Geometry );
const b2_BoxLines = new THREE.LineSegments( b2_BoxEdges, new THREE.LineBasicMaterial( { color: blockColor } ) );
b2_BoxLines.position.set(0.5, -0.2499, -.2)
scene.add( b2_BoxLines );
